...
closure_info_t function_entry_get_info(dyntracer_t *dyntracer,
                                       const SEXP call, const SEXP op,
                                       const SEXP rho);
closure_info_t function_exit_get_info(dyntracer_t *dyntracer,
                                      const SEXP call, const SEXP op,
                                      const SEXP rho, const SEXP retval);
builtin_info_t builtin_entry_get_info(dyntracer_t *dyntracer,
                                      const SEXP call, const SEXP op,
                                      const SEXP rho, function_type fn_type);
builtin_info_t builtin_exit_get_info(dyntracer_t *dyntracer,
                                     const SEXP call, const SEXP op,
                                     const SEXP rho, function_type fn_type,
                                     const SEXP retval);
